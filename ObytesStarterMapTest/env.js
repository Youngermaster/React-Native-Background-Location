 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.expo-ownerstartermaptest.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.startermaptest'; // ios bundle id
const PACKAGE = 'com.startermaptest'; // android package name
const NAME = 'StarterMapTest'; // app name
const EXPO_ACCOUNT_OWNER = 'startermaptest'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'StarterMapTest'; // app scheme
